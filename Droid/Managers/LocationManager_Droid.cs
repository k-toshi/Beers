...
{
	[Service]
	public class LocationManager_Droid : Service, ILocationListener
    {
        ...
        public LocationManager_Droid()
        {
			CurrentLocation = new Beers.Models.Location(0.0,0.0);
        }
		...
		public Beers.Models.Location CurrentLocation { get; set; }
		...
		public double GetDistance(Beers.Models.Location target)
        {
			float[] results = new float[3];

			Android.Locations.Location.DistanceBetween(target.Latitude,target.Longitude,CurrentLocation.Latitude,CurrentLocation.Longitude,results);
