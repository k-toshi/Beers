...
namespace Beers.Services
{
	public static class HttpService
	{
		...
		#region Twitterdemo
		public static async Task<HttpServiceResult<Type>> GetTwitterDataFromServiceWithToken<Type>(string queryString)
		{
			HttpServiceResult<Type> hts = new HttpServiceResult<Type>();
			HttpClient client = new HttpClient();
			client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", TwitterController.GetToken());
