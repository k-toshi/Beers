...
namespace Beers.Droid.Managers
{
	public class StepServiceConnection: Java.Lang.Object, IServiceConnection
    {
        ...
        protected StepServiceBinder binder;

        public StepServiceConnection(StepServiceBinder binder)
        {
            if (binder != null)
            {
                this.binder = binder;
        ...
        public void OnServiceConnected(ComponentName name, IBinder service)
        {
            ...
            StepServiceBinder serviceBinder = service as StepServiceBinder;
            if (serviceBinder != null)
            {
				...
				serviceBinder.Service.StartStepCounts();
            }
        }
